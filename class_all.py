...
class ConvertData:
    ...
    def convertbenh(self):
        ...
        """
        dbbenh = mydb.cursor()
        dbbenh.execute("SELECT * FROM chatbot_ai.benh;")
    ...
    def converttrieuchung(self):
        ...
        dbtrieuchung.execute("SELECT * FROM chatbot_ai.trieuchung;")
    ...
    def getbc(self):
        ...
        if rule:
            ...
            for i in range(len(rule)):
                if rule[i][0] == vtrule[0]:
                    chuan.append(rule[i][1])
                else:
                    dicbc['luat'] = vtrule[0]
                    dicbc['trieuchung'] = chuan
                    dicbc['benh'] = vtrule[2]
    ...
    def gettrieuchung(self):
        ...
        """
        dbtrieuchung=mydb.cursor()
        dbtrieuchung.execute("SELECT * FROM chatbot_ai.suydien order by idbenh")
